...
export class Initial1727367966680 implements MigrationInterface {
    name = 'Initial1727367966680'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_roles_enum" AS ENUM('user', 'admin', 'moderator', 'manager')`);
